...
第一层：紧急事件反应
优先级：最高
触发事件：MOTION_FREE_FALL, `MOTION_SHAKE_VIOLENTLY, MOTION_FLIP, MOTION_UPSIDE_DOWN
特点：
- 无视V-A状态，直接触发
- 反应内容固定，不可配置
- 用于建立物理规律信任感
...
- 执行时间<100ms，确保即时反应建立物理信任感
详细技术实现参考 local_response_system_design.md

第二层：象限相关反应
优先级：高
触发机制：事件类型 + 当前V-A象限
触发事件：TOUCH_TAP, TOUCH_CRADLED, TOUCH_TICKLED, MOTION_SHAKE, MOTION_PICKUP
特点：
- 同一事件在不同情感状态下反应不同
- 遵守状态锁机制
实现方式：
...
响应特点：
MOTION_SHAKE	Valence > 0 (积极象限)	“欢快的咻咻声” + “愉悦地眯起眼” + “身体配合地摇摆”
	Valence < 0 (消极象限)	“不耐烦的‘哼’声” + “皱眉的表情” + “身体抗拒地扭动一下”
MOTION_PICKUP	Valence > 0	“期待的‘嗯？’声” + “眼睛向上看” + “身体轻微前倾”
	Valence < 0	“警惕的短促音” + “眼神警觉” + “身体向后蜷缩”
TOUCH_TAP	Q1 (兴奋)	“俏皮的‘叮’声” + “俏皮地眨一下眼” + “轻快的短震动”
	Q2 (恐惧/压力)	“受惊的‘呀’声” + “惊恐地眨眼” + “一次快速的抖动”
	Q3 (悲伤/无聊)	“微弱的‘嗯…’声” + “无精打采地眨眼” + (无动作)
	Q4 (满足/平静)	“舒适的咕噜声” + “满足地眯起眼” + “轻柔的长震动”
TOUCH_LONG_PRESS	(类似设计，根据V-A象限定义不同的抚摸反应)	
TOUCH_CRADLED	(通常导向Q4)	“极其安心的呼吸声” + “完全放松的闭眼动画” + “模拟心跳的震动”
TOUCH_TICKLED	(通常导向Q1)	“忍不住的大笑声” + “笑到眯起眼的动画” + “不规则的全身抖动”
